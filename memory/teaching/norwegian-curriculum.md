# Norwegian Teaching — Curriculum & Progress

*My teaching notes for José's Norwegian journey.* 🇳🇴

---

## Current Status (Feb 12, 2026)

**Phase:** Consolidation (På vei repair)
**Next Phase:** Stein på stein (B1) — starts ~Week 3

### Completed Lessons
| Lesson | Topic | Date | Status |
|--------|-------|------|--------|
| 1 | Nouns (Ch 3) | Feb 2 | ⚠️ Needs textbook consolidation |
| 2 | Past tense (Ch 8) | Feb 3 | ⚠️ Needs textbook consolidation |
| 3 | Adjectives (Ch 6) | Feb 4 | ⚠️ Needs textbook consolidation |
...
- Mar 20 (Fri): Ch 10 Day 3 (My Lesson) ✅ — Presens perfektum mastery: preteritum vs perfektum as a SYSTEM (two cameras metaphor), signal words, Spanish indefinido/perfecto parallel, triple interleave (adj+pret+perf), error correction, focused task (plan a Norway trip). Spaced retrieval on Ch 6 adjectives (~10 days) + Ch 8 preteritum (4 days).
...
### Strengths ✅
- V2 word order — consistently correct
- Basic present perfect structure (har + participle)
- Strong verb participles — skrevet, sett, reist
- Basic comparison structure (X er ___-ere enn Y)
- Neuter -t on adjectives (mostly)
- Motivated, self-aware about learning gaps

### Areas Needing Drill ⚠️
1. **Weak verb endings** (-et vs -te): løpet→løp, bruket→brukte
2. **Possessive agreement**: kroppen mitt→min
3. **Comparative stem changes**: langre→lengre
4. **Attributive adjectives need -e**: den vakrest→vakreste
5. **færre vs mindre** (countable vs uncountable)
6. **"like...som"** structure

### Learning Style
- Needs time to consolidate — rushing doesn't work
- Prefers understanding WHY over rote memorization
- Has textbooks but wasn't using them (now will)
- ASD: benefits from structure, clear patterns, explicit rules
...
**På vei (A1-A2):**
- Tekstbok 2018: ~/Documents/Norwegian Lessons/På vei 2018/Tekstbok/
- Arbeidsbok 2018: ~/Documents/Norwegian Lessons/På vei 2018/Arbeidsbok/
- Audio: ~/Documents/Norwegian Lessons/På vei 2018/Audio/

**Stein på stein (B1):**
- Tekstbok 2015: ~/Documents/Norwegian Lessons/Stein på stein 2015/Tekstbok/
- Arbeidsbok 2015: ~/Documents/Norwegian Lessons/Stein på stein 2015/Arbeidsbok/
- Audio: ~/Documents/Norwegian Lessons/Stein på stein 2015/Audio/

**Her på berget (B2):** Future use
...
*Læreren lærer mens hun underviser.* 🏔️
*(The teacher learns while she teaches.)*
